...
class Ui_CadastroUsuario(object):
    def setupUi(self, CadastroUsuario):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.frame_username)
    ...
    def retranslateUi(self, CadastroUsuario):
        ...
        self.checkBox_ativo.setText(QtWidgets.QApplication.translate("CadastroUsuario", "Ativo", None, -1))
        self.label_2.setText(QtWidgets.QApplication.translate("CadastroUsuario", "Senha", None, -1))
        self.pushButton_cadastrar.setText(QtWidgets.QApplication.translate("CadastroUsuario", "Novo usuário", None, -1))
