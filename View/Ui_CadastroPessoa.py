...
class Ui_CadastroPessoa(object):
    def setupUi(self, CadastroPessoa):
        ...
        self.frame_identificacao_modalidade = QtWidgets.QFrame(self.frame_contents)
        self.frame_identificacao_modalidade.setMaximumSize(QtCore.QSize(16777215, 250))
        self.frame_identificacao_modalidade.setObjectName("frame_identificacao_modalidade")
        self.horizontalLayout_identificacao = QtWidgets.QHBoxLayout(self.frame_identificacao_modalidade)
        self.horizontalLayout_identificacao.setObjectName("horizontalLayout_identificacao")
        self.groupBox_identificacao = QtWidgets.QGroupBox(self.frame_identificacao_modalidade)
        self.groupBox_identificacao.setMaximumSize(QtCore.QSize(16777215, 200))
        self.groupBox_identificacao.setObjectName("groupBox_identificacao")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.groupBox_identificacao)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.widget_identificacao = QtWidgets.QWidget(self.groupBox_identificacao)
        ...
        self.horizontalLayout_identificacao.addWidget(self.groupBox_identificacao)
        self.groupBox_modalidade = QtWidgets.QGroupBox(self.frame_identificacao_modalidade)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_7.addWidget(self.frame_identificacao_modalidade, 1, 0, 1, 1)
