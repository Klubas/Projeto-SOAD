...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_compra = QtWidgets.QFrame(self.mainFrame)
        ...
        self.pushButton_compra.setMinimumSize(QtCore.QSize(216, 42))
        ...
        self.pushButton_lista_compras.setMinimumSize(QtCore.QSize(0, 33))
        font = QtGui.QFont()
        ...
        self.pushButton_lista_estoque.setMinimumSize(QtCore.QSize(0, 33))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
        font.setWeight(50)
        ...
        self.frame_mercadoria = QtWidgets.QFrame(self.mainFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton_mercadoria.setMinimumSize(QtCore.QSize(216, 42))
        ...
        self.verticalLayout_9.addWidget(self.pushButton_mercadoria)
        self.pushButton_lista_mercadoria = QtWidgets.QPushButton(self.frame_mercadoria)
        self.pushButton_lista_mercadoria.setMinimumSize(QtCore.QSize(0, 33))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
        font.setWeight(50)
        ...
        self.verticalLayout_9.addWidget(self.pushButton_lista_mercadoria)
        self.horizontalLayout.addLayout(self.verticalLayout_9)
        self.verticalLayout_10 = QtWidgets.QVBoxLayout()
        self.verticalLayout_10.setSpacing(3)
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.pushButton_remanufatura = QtWidgets.QPushButton(self.frame_mercadoria)
        self.pushButton_remanufatura.setMinimumSize(QtCore.QSize(216, 42))
        self.pushButton_remanufatura.setMaximumSize(QtCore.QSize(16777215, 16777215))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(199, 199, 199))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.Button, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.Button, brush)
        self.pushButton_remanufatura.setPalette(palette)
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(18)
        font.setWeight(75)
        ...
        self.verticalLayout_10.addWidget(self.pushButton_remanufatura)
        self.pushButton_lista_remanufatura = QtWidgets.QPushButton(self.frame_mercadoria)
        self.pushButton_lista_remanufatura.setMinimumSize(QtCore.QSize(0, 33))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
        font.setWeight(50)
        ...
        self.verticalLayout_10.addWidget(self.pushButton_lista_remanufatura)
        self.horizontalLayout.addLayout(self.verticalLayout_10)
        self.verticalLayout_4.addLayout(self.horizontalLayout)
        self.gridLayout.addWidget(self.frame_mercadoria, 0, 1, 1, 1)
        self.frame_venda = QtWidgets.QFrame(self.mainFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton_venda.setMinimumSize(QtCore.QSize(216, 42))
        ...
        self.pushButton_venda.setStyleSheet("")
        ...
        self.pushButton_lista_vendas.setMinimumSize(QtCore.QSize(0, 33))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
        font.setWeight(50)
        ...
        self.pushButton_lista_itens = QtWidgets.QPushButton(self.frame_venda)
        self.pushButton_lista_itens.setMinimumSize(QtCore.QSize(0, 33))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
        font.setWeight(50)
        font.setBold(False)
        self.pushButton_lista_itens.setFont(font)
        self.pushButton_lista_itens.setAutoFillBackground(True)
        self.pushButton_lista_itens.setAutoDefault(True)
        self.pushButton_lista_itens.setDefault(False)
        self.pushButton_lista_itens.setFlat(True)
        self.pushButton_lista_itens.setObjectName("pushButton_lista_itens")
        self.verticalLayout_6.addWidget(self.pushButton_lista_itens)
        self.gridLayout.addWidget(self.frame_venda, 1, 0, 1, 1)
        self.widget_pessoa = QtWidgets.QWidget(self.mainFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pushButton_pessoa.setMinimumSize(QtCore.QSize(216, 42))
        ...
        self.pushButton_lista_clientes.setMinimumSize(QtCore.QSize(0, 33))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
        font.setWeight(50)
        ...
        self.pushButton_lista_fornecedores.setMinimumSize(QtCore.QSize(0, 33))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
        font.setWeight(50)
        ...
        self.label_logo = QtWidgets.QLabel(self.mainFrame)
        ...
        self.label_logo_empresa = QtWidgets.QLabel(self.frame_2)
        ...
        self.verticalLayout_7.addWidget(self.label_logo_empresa)
        ...
        self.verticalLayout_7.addWidget(self.label_user)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(20, 617, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_compra.setText(QtWidgets.QApplication.translate("MainWindow", "Compras", None, -1))
        ...
        self.pushButton_remanufatura.setText(QtWidgets.QApplication.translate("MainWindow", "Remanufaturas", None, -1))
        ...
        self.pushButton_venda.setText(QtWidgets.QApplication.translate("MainWindow", "Vendas", None, -1))
        self.pushButton_lista_vendas.setText(QtWidgets.QApplication.translate("MainWindow", "Lista de Vendas", None, -1))
        self.pushButton_lista_itens.setText(QtWidgets.QApplication.translate("MainWindow", "Lista de Itens", None, -1))
        self.label_icone_pessoa.setText(QtWidgets.QApplication.translate("MainWindow", "IconRegistro", None, -1))
        self.pushButton_pessoa.setText(QtWidgets.QApplication.translate("MainWindow", "Pessoas", None, -1))
        ...
        self.label_user.setText(QtWidgets.QApplication.translate("MainWindow", "Usuário:", None, -1))
