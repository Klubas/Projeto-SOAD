...
#
# Created: Fri Nov  1 13:32:49 2019
...
class Ui_FiltroPedido(object):
    def setupUi(self, FiltroPedido):
        ...
        FiltroPedido.setMinimumSize(QtCore.QSize(600, 250))
        FiltroPedido.setMaximumSize(QtCore.QSize(645, 280))
    ...
    def retranslateUi(self, FiltroPedido):
        ...
        self.groupBox_4.setTitle(QtWidgets.QApplication.translate("FiltroPedido", "Estoque", None, -1))
        self.checkBox_abertos.setText(QtWidgets.QApplication.translate("FiltroPedido", "Abertos", None, -1))
        self.checkBox_vazios.setText(QtWidgets.QApplication.translate("FiltroPedido", "Exibir vazios", None, -1))
        self.checkBox_inativos.setText(QtWidgets.QApplication.translate("FiltroPedido", "Exibir inativos", None, -1))
        self.groupBox_3.setTitle(QtWidgets.QApplication.translate("FiltroPedido", "Classificação", None, -1))
        self.checkBox_mercadoria.setText(QtWidgets.QApplication.translate("FiltroPedido", "Mercadoria", None, -1))
        self.checkBox_insumo.setText(QtWidgets.QApplication.translate("FiltroPedido", "Insumo", None, -1))
        self.checkBox_casco.setText(QtWidgets.QApplication.translate("FiltroPedido", "Casco", None, -1))
        self.horizontalGroupBox_2.setTitle(QtWidgets.QApplication.translate("FiltroPedido", "Fornecedor", None, -1))
        self.horizontalGroupBox_3.setTitle(QtWidgets.QApplication.translate("FiltroPedido", "Mercadoria", None, -1))
        self.groupBox_entrada.setTitle(QtWidgets.QApplication.translate("FiltroPedido", "Data de entrada", None, -1))
        self.label_2.setText(QtWidgets.QApplication.translate("FiltroPedido", "até", None, -1))
        self.groupBox_saida.setTitle(QtWidgets.QApplication.translate("FiltroPedido", "Data de saída", None, -1))
