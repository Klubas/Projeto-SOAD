...
class Ui_ListaPadrao(object):
    def setupUi(self, ListaPadrao):
        ...
        spacerItem2 = QtWidgets.QSpacerItem(723, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.pushButton_relatorio = QtWidgets.QPushButton(self.frame_buttons)
        ...
        self.horizontalLayout_8.addWidget(self.pushButton_relatorio)
    ...
    def retranslateUi(self, ListaPadrao):
        ...
        self.pushButton_relatorio.setText(QtWidgets.QApplication.translate("ListaPadrao", "Relatório para impressão", None, -1))
