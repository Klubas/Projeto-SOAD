...
class Ui_FiltroEstoque(object):
    def setupUi(self, FiltroEstoque):
        ...
        self.frame1 = QtWidgets.QFrame(self.formGroupBox)
        ...
        self.horizontalGroupBox = QtWidgets.QGroupBox(self.frame1)
        ...
        self.horizontalGroupBox.setCheckable(True)
        ...
        self.dateEdit_data_entrada1 = QtWidgets.QDateEdit(self.horizontalGroupBox)
        ...
        self.dateEdit_data_entrada2 = QtWidgets.QDateEdit(self.horizontalGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_5.addWidget(self.horizontalGroupBox)
        ...
        self.dateEdit_data_saida1 = QtWidgets.QDateEdit(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.dateEdit_data_saida2 = QtWidgets.QDateEdit(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_3.addWidget(self.frame1, 1, 0, 1, 1)
        self.frame_2 = QtWidgets.QFrame(self.formGroupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lineEdit_mercadoria_id = QtWidgets.QLineEdit(self.horizontalGroupBox_2)
        ...
        self.horizontalLayout_2.addWidget(self.lineEdit_mercadoria_id)
        self.lineEdit_mercadoria = QtWidgets.QLineEdit(self.horizontalGroupBox_2)
        self.lineEdit_mercadoria.setEnabled(False)
        self.lineEdit_mercadoria.setObjectName("lineEdit_mercadoria")
        self.horizontalLayout_2.addWidget(self.lineEdit_mercadoria)
        self.horizontalLayout_6.addWidget(self.horizontalGroupBox_2)
        self.gridLayout_3.addWidget(self.frame_3, 0, 0, 1, 1)
        self.gridLayout_2.addWidget(self.formGroupBox, 1, 0, 1, 1)
    ...
    def retranslateUi(self, FiltroEstoque):
        ...
        self.horizontalGroupBox.setTitle(QtWidgets.QApplication.translate("FiltroEstoque", "Data de entrada", None, -1))
        self.label_2.setText(QtWidgets.QApplication.translate("FiltroEstoque", "até", None, -1))
        self.groupBox_2.setTitle(QtWidgets.QApplication.translate("FiltroEstoque", "Data de saída", None, -1))
        ...
        self.checkBox_vazios.setText(QtWidgets.QApplication.translate("FiltroEstoque", "Mostrar itens vazios", None, -1))
        self.horizontalGroupBox_2.setTitle(QtWidgets.QApplication.translate("FiltroEstoque", "Mercadoria", None, -1))
