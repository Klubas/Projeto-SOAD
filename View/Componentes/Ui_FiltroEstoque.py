...
class Ui_FiltroEstoque(object):
    def setupUi(self, FiltroEstoque):
        ...
        self.groupBox_entrada = QtWidgets.QGroupBox(self.frame1)
        ...
        self.horizontalLayout_5.addWidget(self.groupBox_entrada)
        self.groupBox_saida = QtWidgets.QGroupBox(self.frame1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_5.addWidget(self.groupBox_saida)
